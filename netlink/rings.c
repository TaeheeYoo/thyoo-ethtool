...
int rings_reply_cb(const struct nlmsghdr *nlhdr, void *data)
{
	...
	show_u32("header-data-split-thresh-max", "Header data split thresh:\t",
	...
	show_u32("header-data-split-thresh", "Header data split thresh:\t",
...
static const struct param_parser sring_params[] = {
	...
	{
		.arg		= "header-data-split-thresh",
		.type		= ETHTOOL_A_RINGS_HEADER_DATA_SPLIT_THRESH,
		.handler	= nl_parse_direct_u32,
		.min_argc	= 0,
	},
	{}
